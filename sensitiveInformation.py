...
# The first three properties should be read-only. First name and last
# name should not be exposed as properties at all, but instead expose 
# a calculated property of full_name. Address should have a getter and setter.
